...
void LibraryModel::refreshLibrary() {
  ...
  NetworkManager::instance().postGraphQL(graphql::qtui::client::query::GET_CATEGORY_MANGAS::GetOperationName(), graphql::qtui::client::query::GET_CATEGORY_MANGAS::GetRequestText(), std::move(variablesObj),
